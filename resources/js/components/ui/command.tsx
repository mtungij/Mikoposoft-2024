...
>(({ className, ...props }, ref) => (
    <div
        className="flex items-center rounded-md border border-gray-300 dark:border-slate-100 px-2"
        cmdk-input-wrapper=""
    >
        ...
        <CommandPrimitive.Input
            ref={ref}
            className={cn(
                "flex h-10 w-full rounded-md bg-transparent py-1 text-sm outline-none placeholder:text-gray-500 disabled:cursor-not-allowed disabled:opacity-50 dark:placeholder:text-gray-400",
                className
            )}
            {...props}
        />
